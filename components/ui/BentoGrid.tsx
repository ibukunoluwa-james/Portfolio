...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("theibukunjames@gmail.com");
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(11,11,116,1) 35%, rgba(10,103,122,1) 100%)",
      }}
    >
